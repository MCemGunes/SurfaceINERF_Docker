...
# docker build -t nerf_image:cu102 . 

# sudo docker run --gpus all -it --rm  --ipc=host --volume=$PWD/SurfelNeRF-unofficial:/app/ --volume=$PWD/preprocessed_data:/app/SurfelNeRF-unofficial/datasets/preprocessed_data --volume=$PWD/export_Scannet_test:/app/SurfelNeRF-unofficial/datasets/export_Scannet_test --name nerf_container nerf_image:cu102
